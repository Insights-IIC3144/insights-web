...
interface Props {
  ...
  prior?: CompetitivePrior | null;
  loading: boolean;
}

export function CompetitiveKpiGrid({ kpis, prior, loading }: Props) {
  if (loading) {
    return (
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
      <KpiCard
        ...
        value={kpis?.overallSalesShare}
        format={fmtPct}
        prior={prior?.overallSalesShare}
      ...
      <KpiCard
        ...
        value={kpis?.overallVolumeShare}
        format={fmtPct}
        prior={prior?.overallVolumeShare}
      ...
      <KpiCard
        ...
        value={kpis?.priceGapPct}
        format={fmtPct}
        prior={prior?.priceGapPct}
